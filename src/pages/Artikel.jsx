        ...
        <div className="hero">
            <div className="container">
                ...
                <div className="col-lg-6">
                    ...
                    <p className="deskripsi mb-5 text-white" style={{ maxWidth: "600px" }}>
                ...
                <div className="col-lg-6">
                    <img style={{ borderRadius: "25px", width: "630px", height: "300px" }} className="img-fluid" src="/assets/artikel/hero.jpg" alt="Artikel Hero" />
                </div>
                </div>
            </div>
        </div>
                ...
                {artikelData.map((artikel) => (
                    <div className="col-lg-3 col-md-6 mb-4" key={artikel.id}>
                        <div className="card">
                            ...
                            <Link to={`/detail/${artikel.id}`} className="btn btn-primary card-button w-100">
                                Lihat Detail
                            </Link>
                            </div>
                        </div>
